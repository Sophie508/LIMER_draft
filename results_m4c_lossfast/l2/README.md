...
| AA12_POLICY Loss fault, switch/stay policy decides (demonstration) | 0 | n/a | 0/0 |
| AA13_LOSSFAST Loss fault, deep-stall fast detection (latency measurement) | 3 | 0.984 | 3/3 |
